    ...
    return (
      <main style={{ padding: "1rem 4rem", textAlign: "center", fontSize: "1.3rem"}}>
        ...
        <AccordionDetails>
          <Typography>
          <h3>Purpose</h3>
      <p>This browser extension is aimed to collect information about Ads, Ads interests and user behavior  regarding ads. The information collected will
      be used for researching purposes only, and not for commercial usage.
      </p>
      <h3>Data collected and Data handling</h3>
      <p>This is the information that we get access.</p>
      <ul>
        <li><b>Interests: </b><span>We collect interests</span> associated with your
          Facebook, Twitter, LinkedIn and Google profiles. We collect this
